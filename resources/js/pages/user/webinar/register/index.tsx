...
export default function RegisterWebinar({
    ...
    const submitPayment = useCallback(
        ...
        [basePrice, isFree, transactionFee, webinar.id, webinar.price, webinar.strikethrough_price, pointsChecked, pointsToUse, codeType, referralData, promoCode, referralInfo?.code],
    );

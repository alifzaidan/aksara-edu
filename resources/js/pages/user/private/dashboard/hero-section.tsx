            ...
            <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-3">
                ...
                <div className="col-span-2">
                    ...
                    <h1 className="mb-6 text-4xl leading-tight font-bold italic sm:text-5xl">
                        Private Class 1-on-1: Belajar Lebih Fokus dan Personal.
                    </h1>

                    <p className="mb-6 max-w-xl text-lg text-gray-600 dark:text-gray-400">
                        Dapatkan pendampingan langsung dari mentor ahli. Jadwal lebih fleksibel, materi disesuaikan dengan kebutuhan belajarmu untuk
                        hasil yang lebih maksimal.
                    </p>

                    <div className="flex flex-wrap gap-4">
                        <a href="#private">
                            <Button>Lihat Private Class</Button>
                        </a>

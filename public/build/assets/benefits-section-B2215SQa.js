import{j as e}from"./app-CjN6S8wO.js";import{B as s}from"./badge-check-BSkfYrRk.js";/* empty css            */import"./createLucideIcon-C65US1wW.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

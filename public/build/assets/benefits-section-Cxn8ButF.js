import{j as e}from"./app-DNQJ5R4s.js";import{B as s}from"./badge-check-Bbgf64Xf.js";/* empty css            */import"./createLucideIcon-DmLuupi3.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

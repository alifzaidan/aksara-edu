import{j as e}from"./app-CVPcDv_X.js";import{B as s}from"./badge-check-DPIAfZn_.js";/* empty css            */import"./createLucideIcon-BP1eLCaK.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

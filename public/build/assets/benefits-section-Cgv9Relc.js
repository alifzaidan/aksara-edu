import{j as e}from"./app-BaS6gveR.js";import{B as s}from"./badge-check-BkwXCTuQ.js";/* empty css            */import"./createLucideIcon-BEI17-Y9.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

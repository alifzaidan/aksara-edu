<<<<<<<< HEAD:public/build/assets/benefits-section-DMLVih97.js
import{j as e}from"./app-CSAfO7xM.js";import{B as s}from"./badge-check-CFjn6ErY.js";/* empty css            */import"./createLucideIcon-BFFDxE7C.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
========
import{j as e}from"./app-Bx4cKMOG.js";import{B as s}from"./badge-check-CQiDn9PF.js";/* empty css            */import"./createLucideIcon-D5MdZ3Lh.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
>>>>>>>> 48e2e199517bdaa2a90ef5af57300af053061595:public/build/assets/benefits-section-CkvUnR1r.js
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

import{j as e}from"./app-lzbwuAKd.js";import{B as s}from"./badge-check-Cadga6ZJ.js";/* empty css            */import"./createLucideIcon-CAQnL-2j.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

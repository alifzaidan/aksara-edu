import{j as e}from"./app-Cr0H48Wk.js";import{B as s}from"./badge-check-DRTqbrCq.js";/* empty css            */import"./createLucideIcon-2M49j5Eu.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

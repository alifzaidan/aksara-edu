import{j as e}from"./app-Bn2NlWgI.js";import{B as s}from"./badge-check-DYK9HWeH.js";/* empty css            */import"./createLucideIcon-C8opOI7x.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

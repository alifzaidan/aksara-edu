import{j as e}from"./app-DqWmYGCv.js";import{B as s}from"./badge-check-Dk5GYfiq.js";/* empty css            */import"./createLucideIcon-DLGpDV4Z.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

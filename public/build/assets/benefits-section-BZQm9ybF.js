import{j as e}from"./app-COvZ_Bv3.js";import{B as s}from"./badge-check-Df2UDA3R.js";/* empty css            */import"./createLucideIcon-dRTYTdLF.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

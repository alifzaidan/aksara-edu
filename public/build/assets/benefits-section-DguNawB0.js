import{j as e}from"./app-CG8rDlKH.js";import{B as s}from"./badge-check-Dz35AsYT.js";import"./createLucideIcon-BXBWg16j.js";function c(t){if(!t)return[];const i=String(t).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

import{j as e}from"./app-l4GjCaF8.js";import{B as s}from"./badge-check-D3aE2A-J.js";/* empty css            */import"./createLucideIcon-CnWFwfzb.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

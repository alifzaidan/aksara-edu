import{j as e}from"./app-B6m2T-x-.js";import{B as s}from"./badge-check-CEQktmvV.js";/* empty css            */import"./createLucideIcon-CTC_sTa6.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

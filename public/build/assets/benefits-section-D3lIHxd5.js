import{j as e}from"./app-BKbWwDOE.js";import{B as s}from"./badge-check-sX_6TTwo.js";/* empty css            */import"./createLucideIcon-C1nEwgRc.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

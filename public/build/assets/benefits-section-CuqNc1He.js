import{j as e}from"./app-C5zzt8xm.js";import{B as s}from"./badge-check-FBPGzSut.js";import"./createLucideIcon-zvzzjYQM.js";function c(t){if(!t)return[];const i=String(t).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

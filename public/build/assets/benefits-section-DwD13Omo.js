import{j as e}from"./app-CN1pV84L.js";import{B as s}from"./badge-check-DWlj9K3x.js";import"./createLucideIcon-BlZ3HFN5.js";function c(t){if(!t)return[];const i=String(t).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`

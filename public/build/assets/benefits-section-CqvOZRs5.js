import{j as e}from"./app-DKjfDtK0.js";import{B as s}from"./badge-check-BBwYSZwY.js";/* empty css            */import"./createLucideIcon-CfPETseN.js";function c(a){if(!a)return[];const i=String(a).trim();if(!i)return[];const r=i.match(/<li[^>]*>[\s\S]*?<\/li>/gi),l=i.replace(/<br\s*\/?\s*>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/\r\n?/g,`
`).split(`
